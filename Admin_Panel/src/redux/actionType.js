...
export const GET_ANSWER_LIST_FAILED = 'GET_ANSWER_LIST_FAILED'

// GET RESULT OF QUESTION_BY_ID
export const GET_ANSWER_LIST_BY_ID = 'GET_ANSWER_LIST_BY_ID'
export const GET_ANSWER_LIST_BY_ID_SUCCESS = 'GET_ANSWER_LIST_BY_ID_SUCCESS'
export const GET_ANSWER_LIST_BY_ID_FAILED = 'GET_ANSWER_LIST_BY_ID_FAILED'
