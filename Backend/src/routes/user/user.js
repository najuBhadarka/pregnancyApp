...
import { deleteUser, userList, updateUserStatus, getUserById } from "../../controller/userController.js";
...
userRoute.get("/get-user-details/:id", authenticateRoles(['admin']), getUserById)
