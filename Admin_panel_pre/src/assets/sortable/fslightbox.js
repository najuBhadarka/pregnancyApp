...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var o;
      var r = "fslightbox-";
      var i = "".concat(r, "styles");
      var s = "".concat(r, "cursor-grabbing");
      var a = "".concat(r, "full-dimension");
      var c = "".concat(r, "flex-centered");
      var l = "".concat(r, "open");
      var u = "".concat(r, "transform-transition");
      var d = "".concat(r, "absoluted");
      var p = "".concat(r, "slide-btn");
      var f = "".concat(p, "-container");
      var h = "".concat(r, "fade-in");
      var m = "".concat(r, "fade-out");
      var g = h + "-strong";
      var v = m + "-strong";
      var b = "".concat(r, "opacity-");
      var x = "".concat(b, "1");
      var y = "".concat(r, "source");
      function S(e) {
        return (S =
      ...
      (typeof document === "undefined" ? "undefined" : S(document)) ===
        "object" &&
      ...
      function C(e, t) {
        var n = this;
        var o = e.collections.sourceSizers;
        var r = e.elements;
        var i = r.sourceAnimationWrappers;
        var s = r.sourceMainWrappers;
        var a = r.sources;
        var c = e.resolve;
        function l(e, n) {
      ...
      function A(e, t, n) {
        ...
        var r = e.props.customClasses;
        var i = r[t] ? r[t] : "";
        o[t].className = n + " " + i;
      }
      function I(e, t) {
        var n = e.elements.sources;
        var o = e.props.customAttributes;
      ...
      function T(e, t) {
        ...
        var o = e.elements;
        var r = o.sources;
        var i = o.sourceAnimationWrappers;
        var s = e.props.sources;
      ...
      function N(e, t) {
        ...
        var o = e.elements;
        var i = o.sources;
        var s = o.sourceAnimationWrappers;
        var a = e.props.sources;
      ...
      function z(e, t) {
        var n = e.elements;
        var o = n.sources;
        var i = n.sourceAnimationWrappers;
        var s = n.sourceMainWrappers;
        e.props.sources;
      ...
      function M(e) {
        var t = e.collections;
        var n = t.sourceLoadHandlers;
        var o = t.sourcesRenderFunctions;
        var r = e.core.sourceDisplayFacade;
        var i = e.resolve;
        this.runActionsForSourceTypeAndIndex = function (t, s) {
          var a;
          switch ((t !== "invalid" && (n[s] = i(F, [s])), t)) {
            case "image":
              a = T;
              break;
            case "video":
      ...
      function k(e, t) {
        ...
        var o = e.elements;
        var r = o.sourceWrappersContainer;
        var i = o.sourceMainWrappers;
        ...
        (n[t] = function () {
          ...
          (function (e, t) {
            var n = e.elements;
            var o = n.sourceMainWrappers;
            var r = n.sourceAnimationWrappers;
      ...
      function D(e, t) {
        ...
        (n.className = "".concat(r, "toolbar")),
          ...
          (function (e, t) {
            ...
            var o = e.core.fullscreenToggler;
            var r = e.data;
            var i =
      ...
      function j(e) {
        ...
        (o.className = "".concat(r, "nav")),
          ...
          t.length > 1 &&
            (function (e, t) {
              var n = e.componentsServices;
              var o = e.props.sources;
              var i = (e.stageIndexes, document.createElement("div"));
      ...
      function X(e, t) {
        var n = this;
        var o = e.elements.sourceMainWrappers;
        var r = e.props;
        var i = 0;
      ...
      function V(e) {
        var t = this;
        var n = e.core;
        var o = n.eventsDispatcher;
        var r = n.fullscreenToggler;
        var i = n.globalEventsController;
        var s = n.scrollbarRecompensor;
        var a = e.data;
        var c = e.elements;
        var u = e.props;
        var d = e.sourcePointerProps;
      ...
      function Y(e) {
        ...
        var n;
        var o;
        var r = e.collections.sourceMainWrappersTransformers;
        var i = e.componentsServices;
        var s = e.core;
        var a = s.classFacade;
        var c = s.slideIndexChanger;
        var l = s.sourceDisplayFacade;
        var d = s.stageManager;
        var p = e.elements.sourceAnimationWrappers;
        var f = e.stageIndexes;
        var v =
          ((t = function () {
      ...
      function _(e) {
        var t = e.core;
        var n = t.lightboxCloser;
        var o = t.fullscreenToggler;
        var r = t.slideChangeFacade;
      ...
      function q(e) {
        ...
        var n = e.elements;
        var o = e.sourcePointerProps;
        var r = e.stageIndexes;
        function i(e, n) {
      ...
      function Z(e) {
        ...
        (n = (t = e).core.classFacade),
          ...
          (function (e) {
            var t = e.core;
            var n = t.globalEventsController;
            var o = t.windowResizeActioner;
            var r = e.resolve;
            var i = r(_);
            var s = r(J);
            var a = r(Q);
          ...
          (function (e) {
            var t = e.data;
            var n = e.core.scrollbarRecompensor;
            function o() {
          ...
          (function (e) {
            var t = e.core;
            var n = t.slideChangeFacade;
            var o = t.slideIndexChanger;
            var r = t.stageManager;
          ...
          (function (e) {
            var t = e.core;
            var n = t.classFacade;
            var o = t.sourcesPointerDown;
            var r = e.elements.sources;
            var i = e.sourcePointerProps;
            var s = e.stageIndexes;
          ...
          (function (e) {
            ...
            var n = e.core.sourceDisplayFacade;
            var o = e.props;
            var r = e.stageIndexes;
            function i(e) {
              t[e] && (t[e](), delete t[e]);
          ...
          (function (e) {
            ...
            var o = e.props.sources.length - 1;
          ...
          (function (e) {
            var t = e.collections;
            var n = t.sourceMainWrappersTransformers;
            var o = t.sourceSizers;
            var r = e.core.windowResizeActioner;
            var i = e.data;
            var s = e.elements.sourceMainWrappers;
            var a = e.props;
            var c = e.stageIndexes;
      ...
      function ne(e) {
        ...
        var n = e.componentsServices;
        var o = e.core;
        var r = o.eventsDispatcher;
        var i = o.lightboxOpener;
        var s = o.globalEventsController;
        var a = o.scrollbarRecompensor;
        var c = o.sourceDisplayFacade;
        var u = o.stageManager;
        var d = o.windowResizeActioner;
        var p = e.data;
        var f = e.elements;
        var h = e.stageIndexes;
        i.open = function () {
          var o =
