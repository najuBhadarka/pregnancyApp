...
const Menu = () => {
  return (
    <Row>
          ...
          <Card.Body className="py-0">
            <ul className="list-inline">
              <li className="py-4 d-flex justify-content-between">
                <span className="fw-bolder heading-title text-dark">
                  Starters
                </span>
                ...
                <div className="d-flex justify-content-between">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex justify-content-between ms-3">
                      <div>
                        <h6 className="mb-1 fw-bolder heading-title">
                          Veg Cripsy
                        </h6>
                        <small className="mb-0">
                          Tortila chips served with warm cheese sauce
                        </small>
                      </div>
                      <div>
                        <svg
      ...
      <Col lg="3">
        <Card
          style={{ background: `url(${userp02})`, backgroundSize: "cover" }}
        >
          <Card.Body>
            <div className="div">
              <div className="div">
                <h2 className="text-primary text-special">
                  Today’s
                  <br /> Special
                  <br /> Menu
                </h2>
          ...
          <Card.Body>
            ...
            <div className="d-flex pt-3">
              ...
              <div className="d-flex justify-content-between ms-3 w-100">
                <div>
                  <small className="text-dark fw-bolder heading-title">
                    $7,99
                  </small>
              ...
              <li className="pb-3  card rounded-1 mb-3 cusomer-card">
                <div className="card-body px-2 py-2 menu-image">
                  <div className="d-flex">
                    <img
                      src={cust1}
                      className="img-fluid avatar-rounded avatar-40"
                      alt="profileimage"
                    />
                    <div className="ms-2 w-100">
                      <div className="d-flex justify-content-between ">
                        <h6 className="mb-1 heading-title fw-bolder">
                          Jane Coper
                        </h6>
                        <small className="text-dark">
                          Nice place for having snacks.
                        </small>
                      </div>
